...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var makeClickHandler = (function() {
    ...
    team0Link.onclick = function() {
	  
            scores[0][0] += points;
            nukeChildren(scores[0][1]);
            addText(scores[0][1], '' + scores[0][0]);
      m.className += ' showAnswer';
    };
    team1Link.onclick = function() {
	  
            scores[1][0] += points;
            nukeChildren(scores[1][1]);
            addText(scores[1][1], '' + scores[1][0]);
      m.className += ' showAnswer';
    };
